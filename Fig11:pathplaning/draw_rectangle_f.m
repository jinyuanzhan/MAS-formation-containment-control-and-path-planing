% function draw_rectangle_f(x, y, w, h, height_factor)
%     % Draw rectangles given the center's x,y location, width, and height.
%     % This code also takes x, y, w, h as vectors, and height_factor to increase height.
%     % It fills the rectangles with color.
% 
%     for i = 1:size(x,1)
...
% 
%         % Define the vertices
%         x_vertices = [x_top_left, x_top_right, x_bottom_right, x_bottom_left];
%         y_vertices = [y_top_left, y_top_right, y_bottom_right, y_bottom_left];
% 
%         % Fill the rectangle with color
%         fill(x_vertices, y_vertices, 'r'); % 'r' is the color red, you can choose any color you like
